...
COLOR AGIDL_BMPGetClr(const AGIDL_BMP *bmp, int x, int y);
COLOR16 AGIDL_BMPGetClr16(const AGIDL_BMP *bmp, int x, int y);
void AGIDL_BMPSyncPix(const AGIDL_BMP *bmp, const COLOR *clrs);
void AGIDL_BMPSyncPix16(const AGIDL_BMP *bmp, const COLOR16 *clrs);
void AGIDL_BMPCopyPix(const AGIDL_BMP* bmp, const COLOR* clrs, u32 count);
void AGIDL_BMPCopyPix16(const AGIDL_BMP* bmp, const COLOR16* clrs, u32 count);
void AGIDL_BMPSetClr(const AGIDL_BMP *bmp, int x, int y, COLOR clr);
void AGIDL_BMPSetClr16(const AGIDL_BMP *bmp, int x, int y, COLOR16 clr);
void AGIDL_BMPSetRGB(const AGIDL_BMP *bmp, int x, int y, u8 r, u8 g, u8 b);
void AGIDL_BMPSetRGBA(const AGIDL_BMP *bmp, int x, int y, u8 r, u8 g, u8 b, u8 a);
...
void AGIDL_ClearBMP(const AGIDL_BMP *bmp, COLOR clr);
void AGIDL_ClearBMP16(const AGIDL_BMP *bmp, COLOR16 clr);
void AGIDL_ClearColorBMP(const AGIDL_BMP* bmp, float r, float g, float b);
...
void AGIDL_BMPEncodeNearestICP(const AGIDL_BMP* bmp, AGIDL_ICP palette, FILE* file);
