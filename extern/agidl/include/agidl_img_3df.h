...
void AGIDL_3DFSetClr(const AGIDL_3DF* glide, int x, int y, COLOR clr);
void AGIDL_3DFSetClr16(const AGIDL_3DF* glide, int x, int y, COLOR16 clr);
void AGIDL_3DFSetRGB(const AGIDL_3DF* glide, int x, int y, u8 r, u8 g, u8 b);
void AGIDL_3DFSetRGBA(const AGIDL_3DF* glide, int x, int y, u8 r, u8 g, u8 b, u8 a);
void AGIDL_3DFSetColor3f(const AGIDL_3DF* glide, int x, int y, f32 r, f32 g, f32 b);
void AGIDL_3DFSetColor4f(const AGIDL_3DF* glide, int x, int y, f32 r, f32 g, f32 b, f32 a);
void AGIDL_Clear3DF(const AGIDL_3DF* glide, COLOR clr);
void AGIDL_Clear3DF16(const AGIDL_3DF* glide, COLOR16 clr);
void AGIDL_ClearColor3DF(const AGIDL_3DF* glide, float r, float g, float b);
...
COLOR AGIDL_3DFGetClr(const AGIDL_3DF* glide, int x, int y);
COLOR16 AGIDL_3DFGetClr16(const AGIDL_3DF* glide, int, int y);
...
void AGIDL_3DFCopyPix(const AGIDL_3DF* glide, const COLOR* clrs, u32 count);
void AGIDL_3DFCopyPix16(const AGIDL_3DF* glide, const COLOR16* clrs, u32 count);
