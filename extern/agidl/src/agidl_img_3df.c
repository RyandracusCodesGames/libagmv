...
void AGIDL_3DFSetWidth(AGIDL_3DF* glide, const int width){
	glide->width = width;
}

void AGIDL_3DFSetHeight(AGIDL_3DF* glide, const int height){
	glide->height = height;
}

void AGIDL_3DFSetClrFmt(AGIDL_3DF* glide, const AGIDL_CLR_FMT fmt){
	glide->fmt = fmt;
}

void AGIDL_3DFSetICPMode(AGIDL_3DF* glide, const AGIDL_Bool icp){
	glide->icp = icp;
}

void AGIDL_3DFSetICPEncoding(AGIDL_3DF* glide, const AGIDL_ICP_ENCODE encode){
	glide->encode = encode;
}

void AGIDL_3DFSetMaxDiff(AGIDL_3DF* glide, const int max_diff){
	glide->max_diff = max_diff;
}

void AGIDL_3DFBuildMipmap(AGIDL_3DF* glide, const AGIDL_Bool mipped){
	glide->mipped = mipped;
}

void AGIDL_3DFSetClr(const AGIDL_3DF* glide, const int x, const int y, const COLOR clr){
	if(x >= 0 && y >= 0 && x < AGIDL_3DFGetWidth(glide) && y < AGIDL_3DFGetHeight(glide)){
		glide->pixels.pix32[x+y*AGIDL_3DFGetWidth(glide)] = clr;
	}
}

void AGIDL_3DFSetClr16(const AGIDL_3DF* glide, const int x, const int y, const COLOR16 clr){
	if(x >= 0 && y >= 0 && x < AGIDL_3DFGetWidth(glide) && y < AGIDL_3DFGetHeight(glide)){
		glide->pixels.pix16[x+y*AGIDL_3DFGetWidth(glide)] = clr;
	}
}

void AGIDL_3DFSetRGB(const AGIDL_3DF* glide, const int x, const int y, const u8 r, const u8 g, const u8 b){
	if(x >= 0 && y >= 0 && x < AGIDL_3DFGetWidth(glide) && y < AGIDL_3DFGetHeight(glide)){
...
void AGIDL_3DFSetRGBA(const AGIDL_3DF* glide, const int x, const int y, const u8 r, const u8 g, const u8 b, const u8 a){
	if(x >= 0 && y >= 0 && x < AGIDL_3DFGetWidth(glide) && y < AGIDL_3DFGetHeight(glide)){
...
void AGIDL_3DFSetColor3f(const AGIDL_3DF* glide, const int x, const int y, const f32 r, const f32 g, const f32 b){
if(x >= 0 && y >= 0 && x < AGIDL_3DFGetWidth(glide) && y < AGIDL_3DFGetHeight(glide)){
	const int bits = AGIDL_GetBitCount(AGIDL_3DFGetClrFmt(glide));
		if(bits == 24 || bits == 32){
...
void AGIDL_3DFSetColor4f(const AGIDL_3DF* glide, const int x, const int y, const f32 r, const f32 g, const f32 b, const f32 a){
	if(x >= 0 && y >= 0 && x < AGIDL_3DFGetWidth(glide) && y < AGIDL_3DFGetHeight(glide)){
		if(AGIDL_GetBitCount(AGIDL_3DFGetClrFmt(glide)) == 32){
...
u32 AGIDL_3DFGetWidth(const AGIDL_3DF* glide){
	return glide->width;
}

u32 AGIDL_3DFGetHeight(const AGIDL_3DF* glide){
	return glide->height;
}

u32 AGIDL_3DFGetSize(const AGIDL_3DF* glide){
	return AGIDL_3DFGetWidth(glide) * AGIDL_3DFGetHeight(glide);
}

AGIDL_CLR_FMT AGIDL_3DFGetClrFmt(const AGIDL_3DF* glide){
	return glide->fmt;
}

int AGIDL_3DFGetMaxDiff(const AGIDL_3DF* glide){
	return glide->max_diff;
}

COLOR AGIDL_3DFGetClr(const AGIDL_3DF* glide, const int x, const int y){
	if(x >= 0 && y >= 0 && x < AGIDL_3DFGetWidth(glide) && y < AGIDL_3DFGetHeight(glide)){
...
COLOR16 AGIDL_3DFGetClr16(const AGIDL_3DF* glide, const int x, const int y){
	if(x >= 0 && y >= 0 && x < AGIDL_3DFGetWidth(glide) && y < AGIDL_3DFGetHeight(glide)){
...
void AGIDL_Clear3DF(const AGIDL_3DF *glide, const COLOR clr){
...
void AGIDL_Clear3DF16(const AGIDL_3DF *glide, const COLOR16 clr){
	if(AGIDL_GetBitCount(AGIDL_3DFGetClrFmt(glide)) == 16){
		AGIDL_ClrMemset16(glide->pixels.pix16,clr,AGIDL_3DFGetSize(glide));
	}
	else{
...
void AGIDL_ClearColor3DF(const AGIDL_3DF* glide, const float r, const float g, const float b){
	if(AGIDL_GetBitCount(AGIDL_3DFGetClrFmt(glide)) == 16){
...
void AGIDL_Flush3DF(const AGIDL_3DF* glide){
	AGIDL_Clear3DF(glide,0);
}

void AGIDL_3DFSyncPix(const AGIDL_3DF *glide, const COLOR *clrs){
	if(AGIDL_GetBitCount(AGIDL_3DFGetClrFmt(glide)) != 16){
		AGIDL_ClrMemcpy(glide->pixels.pix32,clrs,AGIDL_3DFGetSize(glide));
	}
}

void AGIDL_3DFSyncPix16(const AGIDL_3DF *glide, const COLOR16 *clrs){
	if(AGIDL_GetBitCount(AGIDL_3DFGetClrFmt(glide)) == 16){
		AGIDL_ClrMemcpy16(glide->pixels.pix16,clrs,AGIDL_3DFGetSize(glide));
	}
}

void AGIDL_3DFCopyPix(const AGIDL_3DF* glide, const COLOR* clrs, const u32 count){
	if(AGIDL_GetBitCount(AGIDL_3DFGetClrFmt(glide)) != 16){
		AGIDL_ClrMemcpy(glide->pixels.pix32,clrs,count);
	}
}

void AGIDL_3DFCopyPix16(const AGIDL_3DF* glide, const COLOR16* clrs, const u32 count){
	if(AGIDL_GetBitCount(AGIDL_3DFGetClrFmt(glide)) == 16){
...
void AGIDL_ColorConvert3DF(AGIDL_3DF* glide, const AGIDL_CLR_FMT dest){
	const u8 sbits = AGIDL_GetBitCount(AGIDL_3DFGetClrFmt(glide)), dbits = AGIDL_GetBitCount(dest);
...
AGIDL_3DF * AGIDL_Create3DF(const char* filename, const int width, const int height, const AGIDL_CLR_FMT fmt){
...
AGIDL_3DF* AGIDL_3DFCpyImg(const AGIDL_3DF* glide){
...
int AGIDL_3DFDecodeHeader(AGIDL_3DF* glide, FILE* file){
	...
	const GLIDE_ASPECT_TABLE a = AGIDL_3DFGetAspect(aspect);
...
u8 AGIDL_GetCharNum(const char num){
	switch(num){
		case '0':{
			return 0;
		}
...
char AGIDL_GetNumChar(const u8 c){
	switch(c){
		case 0:{
			return '0';
		}break;
...
void AGIDL_3DFEncodeHeader(const AGIDL_3DF* glide, FILE* file){
	...
	if(glide->icp != TRUE){
		switch(AGIDL_3DFGetClrFmt(glide)){
			case AGIDL_RGB_555:{
				const char format[8] = "argb1555";
				fwrite(format,1,8,file);
				AGIDL_WriteByte(file,10);
			}break;
			case AGIDL_RGB_565:{
				const char format[6] = "rgb565";
				fwrite(format,1,6,file);
				AGIDL_WriteByte(file,10);
			}break;
			case AGIDL_RGBA_8888:{
				const char format[8] = "argb4444";
				fwrite(format,1,8,file);
				AGIDL_WriteByte(file,10);
			}break;
	...
	if(glide->mipped == TRUE){
		if(w > h){
			switch(w){
				case 2:{
					const char size[3] = "1 2";
					fwrite(size,1,3,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 4:{
					const char size[3] = "1 4";
					fwrite(size,1,3,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 8:{
					const char size[3] = "1 8";
					fwrite(size,1,3,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 16:{
					const char size[4] = "1 16";
					fwrite(size,1,4,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 32:{
					const char size[4] = "1 32";
					fwrite(size,1,4,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 64:{
					const char size[4] = "1 64";
					fwrite(size,1,4,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 128:{
					const char size[5] = "1 128";
					fwrite(size,1,5,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 256:{
					const char size[5] = "1 256";
					fwrite(size,1,5,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 512:{
					const char size[5] = "1 512";
					fwrite(size,1,5,file);
					AGIDL_WriteByte(file,10);
				}break;
			}
		...
		if(w > h){
			switch(w){
				case 2:{
					const char size[3] = "2 2";
					fwrite(size,1,3,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 4:{
					const char size[3] = "4 4";
					fwrite(size,1,3,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 8:{
					const char size[3] = "8 8";
					fwrite(size,1,3,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 16:{
					const char size[5] = "16 16";
					fwrite(size,1,5,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 32:{
					const char size[5] = "32 32";
					fwrite(size,1,5,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 64:{
					const char size[5] = "64 64";
					fwrite(size,1,5,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 128:{
					const char size[7] = "128 128";
					fwrite(size,1,7,file);
					AGIDL_WriteByte(file,10);
				}break;
				case 256:{
					const char size[7] = "256 256";
					fwrite(size,1,7,file);
					AGIDL_WriteByte(file,10);
				}break;
			}
	...
	const char aspect[14] = "aspect ratio: ";
	fwrite(aspect,1,14,file);

	if(w == h){
		const char ratio[3] = "1 1";
...
void AGIDL_3DFEncodeICP(AGIDL_3DF* glide){
	if(glide->encode == ICP_ENCODE_THRESHOLD){
		...
		for(int y = 0; y < AGIDL_3DFGetHeight(glide); y++){
			for(int x = 0; x < AGIDL_3DFGetWidth(glide); x++){
				const COLOR clr = AGIDL_3DFGetClr(glide,x,y);
...
AGIDL_3DF * AGIDL_Load3DF(char* filename){
	...
	const int error = AGIDL_3DFDecodeHeader(glide,file);
